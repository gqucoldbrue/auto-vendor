...
import { isBaseCondition, isObject, toRem as toRem2, withoutSpace } from "@pandacss/shared";
...
// src/jsx.ts
import { capitalize as capitalize2, memo as memo2 } from "@pandacss/shared";
var JsxEngine = class {
  constructor(context) {
    this.context = context;
  ...
  get upperName() {
    return capitalize2(this.jsxFactory);
  }
  get typeName() {
    return `HTML${capitalize2(this.jsxFactory)}Props`;
  }
  get variantName() {
    return `${capitalize2(this.jsxFactory)}VariantProps`;
  }
  get componentName() {
    return `${capitalize2(this.jsxFactory)}Component`;
  }
  isJsxFactory = (name) => {
...
// src/patterns.ts
import { capitalize as capitalize3, createRegex, dashCase, getPatternStyles, isObject as isObject2, memo as memo3, uncapitalize } from "@pandacss/shared";
var Patterns = class {
  constructor(options) {
    this.options = options;
...
var Recipes = class _Recipes {
  ...
  assignRecipe = (name, recipe) => {
    ...
    const capitalized = capitalize4(name);
    const jsx = Array.from(recipe.jsx ?? [capitalized]);
    if ("slots" in recipe) {
      jsx.push(...recipe.slots.map((slot) => capitalized + "." + capitalize4(slot)));
    }
